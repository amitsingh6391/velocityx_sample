...
class AnimatedBackground extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final tween = MultiTween<_ColorTween>()
      ..add(
        _ColorTween.color1,
        Color(0xff8a113a).tweenTo(Colors.black),
        3.seconds,
      )
      ..add(
        _ColorTween.color2,
        Color(0xff440216).tweenTo(Colors.black),
        3.seconds,
      );
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      child: Column(children: [
        HeaderScreen(),
        size.width < 600 ? IntroductionWidget() : Text(""),
        Text("MY SKILLS", style: TextStyle(fontSize: 30, color: Colors.yellow)),
        BarChartApplication(),
        MiddleScreen(),
        SizedBox(height: 20),
        EducationScreen(),
